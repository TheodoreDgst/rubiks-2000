use super::cube::Cube;
use super::enums::{Corner as Co, Edge as Ed,Facelet as Fc, Color as Cl};
...
pub const MAX_DEPTH_PHASE_1: u8 = 13; // I think it's 7 rather
pub const N_COLORS: u8 = 6;
...
pub const CO_U: [u8; 8] = [1, 1, 1, 1, 0, 0, 0, 0];
...
fn initialize_all_moves() -> [Cube; 18] {
    ...
    for i in 0..6 {
        let mut cube = Cube::new_default();
        for j in 0..3 {
            cube.multiply(BASE_MOVES[i]);
            all_move_tab[3 * i + j] = Cube::new(cube.get_cp(), cube.get_co(), cube.get_ep(), cube.get_eo());
        }
    }
...
[
    ...
    [Fc::U1, Fc::L1, Fc::B3], [Fc::U3, Fc::B1, Fc::R3],
    [Fc::D3, Fc::F9, Fc::R7], [Fc::D1, Fc::L9, Fc::F7], 
    [Fc::D7, Fc::B9, Fc::L7], [Fc::D9, Fc::R9, Fc::B7]
];

//Map the edge positions to facelet positions.
pub const EDGE_FACELET : [[Fc;2];12] = 
[
    [Fc::U6, Fc::R2], [Fc::U8, Fc::F2],
    [Fc::U4, Fc::L2], [Fc::U2, Fc::B2],
    [Fc::D6, Fc::R8], [Fc::D2, Fc::F8],
    [Fc::D4, Fc::L8], [Fc::D8, Fc::B8],
    [Fc::F6, Fc::R4], [Fc::F4, Fc::L6],
    [Fc::B6, Fc::L4], [Fc::B4, Fc::R6]
];
